...
CREATE TABLE "books" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "title" varchar, "discription" text, "rating" integer, "year" integer, "isbn" integer, "publisher_id" integer, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
